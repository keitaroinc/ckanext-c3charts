...
class ChartsPlugin(plugins.SingletonPlugin, DefaultTranslation):
    ...
    def setup_template_variables(self, context, data_dict):
        ...
        return {'resource': resource,
                ...
                'chart_types': [{'value': toolkit._('Bar Chart')},
                                {'value': toolkit._('Stacked Bar Chart')},
                                {'value': toolkit._('Donut Chart')},
                                {'value': toolkit._('Line Chart')},
                                {'value': toolkit._('Pie Chart')},
                                {'value': toolkit._('Spline Chart')}],
